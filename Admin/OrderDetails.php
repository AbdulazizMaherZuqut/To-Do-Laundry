...
include("header.php");
(!isset($_SESSION['id'])) ? header('Location:ALogin.php') : '';
...
if($id != ''){
    ...
    if($order->rowCount() != 0){
            ...
            <div class="col-md-8 m-auto">
                <div class="card">
                    <div class="card-header">
                        <h3 class="login-header"> <?= $t['AOrder_Details'] ?> </h3>
                    </div>
                    <div class="card-body">
                        <form action="" method="POST">
                            ...
                            <p><b><label> <?= $t['Change_Status:'] ?> </label></b><br>
                                ...
                                <input type="submit" name="status" value="preparing" />
                                <input type="submit" name="status" value="ready_to_received" />
                                ...
                                $st = $info['orderStatus'];
                                if($st == 'submit'){
                                    echo '<input type="submit" name="status" value="cancel" />';
                                }else {
        ...
        echo '<center><a href="BrowseOrder.php" class="btn btn-warning">'.$p1.'</a></center>';
    }
}else{
    echo '<meta http-equiv="Refresh" content="0; URL=BrowseOrder.php">';
}
include("footer.php");