<?php
    ...
    include ("../connect.php");
    include("../init.php");
    (isset($_SESSION['driver_id'])) ? header("Location: index.php") : '';
    $page_title = "Driver Login Page";
?>
<!DOCTYPE html>
                ...
                <div class="card-body">
                    ...
                    if(empty($email) or $email == " " or empty($pass) or $pass == " "){
                        ...
                        echo '<div class="alert alert-danger">'
                            ...
                            $stmt = $db->query("SELECT * FROM drivers WHERE EmailOfDriver = '$email' AND Password = '$pass'");
                            $count = $stmt->rowCount();
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" >
                        ...
                        <input type="password" name="passD" class="form-control" autocomplete="off"
