    ...
    <div class="container">
        <div class="row" style="margin-top: 50px;" >
            <div class="col-md-12 m-auto text-center">
                ...
                <?php
                    if(isset($_SESSION['driver_id'])){
                        ...
                        if(isset($_SESSION['lang']) && $_SESSION['lang'] == 'ar') {
                            echo 'مرحبا بك ' . " \" " . $info['nameOflDriver_ar'] . " \" ";
                        } else{
                            echo 'Welcome' . " \" " . $info['nameOfDriver'] . " \" ";
                        }
                    }
                ?>
                <br>
                ...
                <b><a href="DriverProfilePage.php" class="btn btn-primary"> <?= $t['My_Profile'] ?> </a></b>
                <b><a href="showorder.php" class="btn btn-primary"> <?= $t['Show_Orders'] ?> </a></b>
                <b><a href="editProfile.php" class="btn btn-primary"> <?= $t['Edit_My_Profile'] ?> </a></b>
                <b><a href="Dlogout.php" class="btn btn-primary" > <?= $t['Log_out'] ?> </a></b>
