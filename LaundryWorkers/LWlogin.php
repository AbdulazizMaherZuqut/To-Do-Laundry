<?php
    ...
    include ("../connect.php");
    include('../init.php');
    (isset($_SESSION['laundryworker_id'])) ? header("Location: index.php") : '';
    $page_title = "Laundry Worker Login Page";
?>
    <!DOCTYPE html>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    if(isset($_POST['login'])){
                        ...
                        if(empty($emailOfLW) or $emailOfLW == " " or empty($passOfLW) or $passOfLW == " "){
                            ...
                            $stmt = $db->query("SELECT * FROM laundryworker WHERE EmailOfLaundryWorker='$emailOfLW'
                                  AND Password = '$passOfLW'");
                            $count = $stmt->rowCount();

                            if($count > 0 ){
                                $data = $stmt->fetch();
                                $_SESSION['laundryworker_id'] = $data['id'];
